...
export function add_domain(domain, current_domains_json) {
    ...
    try {
        ...
        const ptr1 = passStringToWasm0(current_domains_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.add_domain(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
...
export function delete_domain(domain, current_domains_json) {
    ...
    try {
        ...
        const ptr1 = passStringToWasm0(current_domains_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.delete_domain(ptr0, len0, ptr1, len1);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
...
export function get_host_class(host) {
    ...
    try {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.get_host_class(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
export function import_domains(imported_json, current_domains_json, mode) {
    ...
    let deferred5_1;
    try {
        const ptr0 = passStringToWasm0(imported_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(current_domains_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(mode, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.import_domains(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
...
export function sanitize_and_validate_domain(domain) {
    const ptr0 = passStringToWasm0(domain, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.sanitize_and_validate_domain(ptr0, len0);
    let v2;
    if (ret[0] !== 0) {
...
export function should_bypass(host, domains_json, settings_json) {
    const ptr0 = passStringToWasm0(host, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(domains_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
